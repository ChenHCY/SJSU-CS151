...
public class FullTimeHourlyEmployee extends Employee
{
	...
	public FullTimeHourlyEmployee(String firstName, String lastName, int age, int socialSecurityNumber) 
	{
	...
	{
		return String.format(super.toString() + "[Full-time Hourly Employees]" + "The pay can recived was $" + getTotalPay());
	}
}
