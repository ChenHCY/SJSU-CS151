...
public class Employee 
{
    ...
    public double computepay(int unitsWorked)
    {
      try{
		...
		System.out.println("NumberFormatException occured: Negative number of hours specified");
	}catch(TooManyHoursWorkedException e){
		System.out.println("TooManyHoursWorkedException occured: More than 40 hours specified");
	}
    	return totalPay;
    }
